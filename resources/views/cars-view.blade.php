...
@section('content')
 <!-- BEGIN PAGE HEADER-->
    ...
    <div class="car-list-page">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert {{ Session::get('success') ? 'alert-success' : 'alert-danger' }}">{{ Session::get('status') }}</div>
            </div>
        </div>
        @endif
        <div class="row">
            <div class="col-md-12">
                <div ng-controller="carViewController" class="portlet light ">
                    ...
                    <div class="portlet-body">
                        <form role="form" method="POST" action="{{url('/cars/'.$car->cid.'/edit')}}" >
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group form-md-line-input form-md-floating-label {{$errors->has('cbid') ? 'has-error' : ''}}">
                                        <select name="cbid" value="{{old('cbid', ''.$car->cbid.'')}}" class="form-control edited" id="brand">
                                            ...
                                            <option value="{{$brand->cbid}}" {{$brand->cbid == $car->cbid ? 'selected' : ''}}>{{$brand->name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group form-md-line-input form-md-floating-label {{$errors->has('car_types') ? 'has-error' : ''}}">
                                        <select value="{{old('car_types', strtoupper($car->car_types))}}" name="car_types" class="form-control edited" id="type">
                                            <option value=" ">Please select...</option>
                                            <option value="SEDAN" {{strtoupper($car->car_types) == 'SEDAN' ? 'selected' : ''}}>Sedan</option>
                                            <option value="SUV" {{strtoupper($car->car_types) == 'SUV' ? 'selected' : ''}}>SUV</option>
                                            <option value="HATCHBACK" {{strtoupper($car->car_types) == 'HATCHBACK' ? 'selected' : ''}}>Hatchback</option>
                                            <option value="SPORT" {{strtoupper($car->car_types) == 'SPORT' ? 'selected' : ''}}>Sport</option>
                                        </select>
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group form-md-line-input form-md-floating-label {{$errors->has('transition_mode') ? 'has-error' : ''}}">
                                        <select value="{{old('transition_mode', $car->transition_mode)}}" name="transition_mode" class="form-control edited" id="transition">
                                            <option value="AUTO" {{$car->transition_mode == 'AUTO' ? 'selected' : ''}}>Automatic</option>
                                            <option value="MANUAL" {{$car->transition_mode == 'MANUAL' ? 'selected' : ''}}>Manual</option>
                                        </select>
